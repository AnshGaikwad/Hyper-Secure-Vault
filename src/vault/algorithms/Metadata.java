...
/**
 * The {@code Metadata} class is used by {@link vault.algorithms.GifSteganography} and {@link vault.algorithms.GifSequenceWriter} to extract metadata from a gif image.
 * This data will be used to recreate the gif after embedding the metadata in the image using {@link vault.algorithms.GifSteganography}.
 */
class Metadata {
